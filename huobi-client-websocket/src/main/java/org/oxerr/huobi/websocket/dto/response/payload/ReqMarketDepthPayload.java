 ...
 */
public class ReqMarketDepthPayload extends ReqMarketDepthTopPayload implements
		Depth {
	...
	public ReqMarketDepthPayload(String symbolId, Percent percent, long time,
		...
		super(symbolId, time, version, bidName, bidPrice, bidTotal, bidAmount,
				askName, askPrice, askTotal, askAmount);
